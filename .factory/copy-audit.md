...
Checked 2026-09-06. Counts use space-separated words. All visible fixed landing copy is below; game-specific titles, diagrams, choices, prompts, nudges, and endings are authored separately in `src/data/puzzles.ts` and validated as puzzle content.
...
| Your puzzle progress is stored only in this browser. | 10 | Pass |
...
| Concept | One term |
| --- | --- |
| Individual challenge | puzzle |
| Whole collection | anthology |
| Optional help | nudge |
| Wrong-answer allowance | mark |
| Isolated sample run | demo |
| Browser-stored state | local progress |
